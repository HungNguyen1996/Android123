package com.minhhung.apporderfood;
...
import com.minhhung.apporderfood.CustomAdapter.AdapterHienThiLoaiMonAn;
import com.minhhung.apporderfood.DAO.LoaiMonAnDAO;
import com.minhhung.apporderfood.DAO.MonAnDAO;
import com.minhhung.apporderfood.DTO.LoaiMonAnDTO;
import com.minhhung.apporderfood.DTO.MonAnDTO;
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.btnDongYThemMonAn:
                ...
                if(tenmonan != null && giatien != null && !tenmonan.equals("") && !giatien.equals("") && !tenmonan.isEmpty()
                        && !giatien.isEmpty() && !tenmonan.trim().isEmpty() && !tenmonan.trim().isEmpty() ){
